...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.append(
        ComposableNode(
            ...
            plugin="autoware_pointcloud_preprocessor::CropBoxFilterComponent",
            name="crop_box_filter_self",
            remappings=[
                ("input", "pointcloud_raw_ex"),
                ("output", "self_cropped/pointcloud_ex"), # was self_cropped/pointcloud_ex
            ],
    ...
    # # Ending the pipeline here for testing purposes, will reintroduce in the future

    nodes.append(
        ComposableNode(
            package="autoware_pointcloud_preprocessor",
            plugin="autoware_pointcloud_preprocessor::DistortionCorrectorComponent",
    ...
    nodes.append(
        ComposableNode(
            package="autoware_pointcloud_preprocessor",
            plugin="autoware_pointcloud_preprocessor::RingOutlierFilterComponent",
